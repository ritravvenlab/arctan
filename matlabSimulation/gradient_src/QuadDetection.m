...
t0 = gcordicatan2(pts(2,2) - pts(1,2),pts(2,1) - pts(1,1),luts);
t1 = gcordicatan2(pts(3,2) - pts(2,2),pts(3,1) - pts(2,1),luts);
t2 = gcordicatan2(pts(4,2) - pts(3,2),pts(4,1) - pts(3,1),luts);
t3 = gcordicatan2(pts(1,2) - pts(4,2),pts(1,1) - pts(4,1),luts);
